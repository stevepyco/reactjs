...
// Webpack uses `PUBLIC_PATH` to determine where the app is being served from.
...
// `PUBLIC_URL` is just like `publicPath`, but we will provide it to our app
// as %PUBLIC_URL% in `index.html` and `process.env.PUBLIC_URL` in JavaScript.
// Omit trailing slash as %PUBLIC_URL%/xyz looks better than %PUBLIC_URL%xyz.
const PUBLIC_URL = PUBLIC_PATH.slice(0, -1);
// Get environment variables to inject into our app.
const ENVIRONMENT = getClientEnvironment(PUBLIC_URL);

// Assert this just to be safe.
// Development builds of React are slow and not intended for production.
if (ENVIRONMENT.stringified['process.env'].NODE_ENV !== '"production"') {
...
module.exports = {
  ...
  resolve: {
    ...
    extensions: ['.mjs', '.web.js', '.js', '.scss', '.json', '.web.jsx', '.jsx'],
    alias: {
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          {
            test: /\.(bmp|jpg|jpeg|gif|png|woff|woff2|eot|otf|ttf|svg|ico|pdf)$/,
